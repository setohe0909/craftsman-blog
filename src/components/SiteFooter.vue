  ...
  <footer class="text-white bg-gray-800">
    ...
    >
      <div class="mb-8 lg:mb-0">
        <div class="mb-3">
          ...
          <p>
            ...
            <a
              ...
              class="border-b border-transparent hover:border-orange-400 transition-border-color"
              >craftsman.lol</a
            >
            with
            <a
        ...
        <div class="mb-3">
          <a href="/feed.xml" class="font-normal text-white hover:text-gray-400"
            >RSS Feed</a
          >
          |
          <a href="/sitemap.xml" class="font-normal text-white hover:text-gray-400"
            >Sitemap</a
          >
        </div>
